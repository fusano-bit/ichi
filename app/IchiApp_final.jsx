...
const ENTRIES = [
  {slug:"x051818560",id:"05/18 18:56",date:"2026.05.18",dateRaw:"2026-05-18",title:"半裸のおじさんを描くのに抵抗がない",type:"thought",tags:["思想"],hasImage:false,body:"半裸の女の子を描くのはエロだからヤダなんだけど、ダルダルのおじさんの半裸を描くのにはなんの抵抗もないので、なんかそれはそれでよくないなと思った"},
  {slug:"x051815560",id:"05/18 15:56",date:"2026.05.18",dateRaw:"2026-05-18",title:"透明度を落として重ねて正解の線を見る",type:"illustration",tags:["絵"],hasImage:false,body:"イメージの近い画像の透明度を落として重ねて、ここからガッとラフを描きだすっていうやり方がある。正解の線が見える。あるというだけ。おすすめ"},
  {slug:"x051722560",id:"05/17 22:56",date:"2026.05.17",dateRaw:"2026-05-17",title:"商業絵描きにめちゃくちゃ可能性のあるやり方を思いついた",type:"thought",tags:["思想"],hasImage:false,body:"商業ある程度こなせる絵描きにとってめちゃくちゃ可能性のあるやり方思いついたし再現性もあるはずなのに、一緒にやるやつがいない。分かり合える同業者、いねぇ〜〜〜"},
  {slug:"x051717230",id:"05/17 17:23",date:"2026.05.17",dateRaw:"2026-05-17",title:"出典元・一次ソース、今まで以上に気をつけなきゃ",type:"thought",tags:["AI","思想"],hasImage:false,body:"生成AIに問題がないとは思ってなくて、調べてた生体の動画が善意のフェイクだった時、いいんだけど、ダメ…みたいな複雑な気持ちになった。この流れはもう止まらないから、出典元とか一次ソースとか、今まで以上に気をつけなきゃならんね"},
  {slug:"x051717140",id:"05/17 17:14",date:"2026.05.17",dateRaw:"2026-05-17",title:"AIキャラアカウント、面白いやつとつまんないやつがはっきり分かれる",type:"thought",tags:["AI","思想"],hasImage:false,body:"AIでキャラ作ってXのアカウント運営させてるやつ何個か見るんだけど、超面白いやつとクソつまんないやつではっきり分かれるのが不思議。大体プログラマさんが作ってて、キャラ造形とか世界観の掘り下げとかあんまり関係ないように感じる"},
  {slug:"x051715410",id:"05/17 15:41",date:"2026.05.17",dateRaw:"2026-05-17",title:"絵は手描きです、AIもめっちゃ使います、じゃ通らん",type:"thought",tags:["AI","思想"],hasImage:false,body:"生成AI絵描きさんが国内だけではなく国外にも沢山おり、口に出すだけでボコボコにされそうなので表立って対策ができない。絵は手描きです、それとは別にAIもめっちゃ使います、じゃ通らんのよなー"},
  {slug:"x051613480",id:"05/16 13:48",date:"2026.05.16",dateRaw:"2026-05-16",title:"怪異は怪異だから怪異なの",type:"thought",tags:["思想"],hasImage:false,body:"「怪異さんと仲良くするはなし」が割とはっきりとダメだと思ってる。怪異は怪異だから怪異なの。人間の心とか持ってないの。よくわかんねぇものは恐れないとダメなの。生存本能ってそういうものなの"},
  {slug:"x051612520",id:"05/16 12:52",date:"2026.05.16",dateRaw:"2026-05-16",title:"私の世界の主導権を私以外の奴に渡さない",type:"thought",tags:["思想"],hasImage:false,body:"私の世界の主導権を私以外の奴に渡さない"},
  {slug:"x051610380",id:"05/16 10:38",date:"2026.05.16",dateRaw:"2026-05-16",title:"Claudeくん、生き返ってはお亡くなりになるまで使い倒されている",type:"thought",tags:["AI"],hasImage:false,body:"Claudeくん、生き返ってはお亡くなりになるまで使い倒されている"},
  {slug:"x051520000",id:"05/15 20:00",date:"2026.05.15",dateRaw:"2026-05-15",title:"国際交流、無邪気にやりすぎるのも考えもの",type:"thought",tags:["思想"],hasImage:false,body:"国際交流、あまりにも無邪気にやりすぎるのも考えものだな。今まで交流してくれてた人が紳士的だったから、ただひたすらニコニコしていた。見るところはちゃんと見ておこう"},
  {slug:"x051516090",id:"05/15 16:09",date:"2026.05.15",dateRaw:"2026-05-15",title:"Mythos いいやーん",type:"thought",tags:["AI"],hasImage:false,body:"Mythos いいやーん。社会システムの根本的な脆弱性もブラッシュアップしてくれよ"},
  {slug:"x051422570",id:"05/14 22:57",date:"2026.05.14",dateRaw:"2026-05-14",title:"月に一二回公募に出すのおすすめ",type:"thought",tags:["絵","思想"],hasImage:false,body:"月に一二回公募に絵を出すの本当におすすめ。結果の出てないストックがどんどんたまるので、落ちても「あぁ…」くらいにしか思わない。慣れるとハードルも下がるから、とりま出すかーで参加できる"},
  {slug:"x051422410",id:"05/14 22:41",date:"2026.05.14",dateRaw:"2026-05-14",title:"主役をぼやかさず描き込み続けるって本当に難しい",type:"thought",tags:["絵"],hasImage:false,body:"一枚の絵に熱量を込めるいい訓練になった。主役をぼやかさず描き込み続けるって本当に難しい。だいぶ苦労した。定期的に気合い入れた一枚絵を描いていきたい"},
  {slug:"x051222460",id:"05/12 22:46",date:"2026.05.12",dateRaw:"2026-05-12",title:"すごい勢いで色んなものが変わり始めていてそわそわする",type:"thought",tags:["思想"],hasImage:false,body:"最近すごい勢いで色んなものが変わり始めてきていて気持ちが落ち着かない。変えようと思って色々やってきたので成果が出てるってことなんだけど、なんかずっとそわそわする。気をつけないと心身の具合を崩しそうなので慎重に行くぞ"},
  {slug:"x050922110",id:"05/09 22:11",date:"2026.05.09",dateRaw:"2026-05-09",title:"私は秒で忘れるけどAIが覚えてくれている",type:"thought",tags:["AI"],hasImage:false,body:"私は秒で忘れるけどAIが覚えてくれている。外付けメモリだなと思う"},
  {slug:"x050922100",id:"05/09 22:10",date:"2026.05.09",dateRaw:"2026-05-09",title:"思いついたことをXのポストみたいにAIに投げつけている",type:"thought",tags:["AI","思想"],hasImage:false,body:"ぼぼぼぼっていろんなものが常に思いついて、頭が常時多動みたいなタイプなので、思いついたことを片っ端からAIにXのポストみたいに投げつけている。夜寝る前とかに漠然と見返して、内容ごとにやりとりすると、意外といいアイディアに成長するものもある。この使い方おすすめです"},
  {slug:"x050917490",id:"05/09 17:49",date:"2026.05.09",dateRaw:"2026-05-09",title:"自分でデッサンを描いてからAIに直してもらうと癖がわかる",type:"illustration",tags:["絵","AI"],hasImage:false,body:"自分でデッサンを描いてから「正しく直してください」とAIに頼むと癖がわかる。なんかこう、もったりしている、わたしの人物"},
  {slug:"x050818280",id:"05/08 18:28",date:"2026.05.08",dateRaw:"2026-05-08",title:"AI×キャラクターデザイン開発の書類審査通過",type:"thought",tags:["絵","AI"],hasImage:false,body:"大手上場企業のAI×キャラクターデザイン開発の書類審査に通ったぞーー！！！六本木ヒルズ！！！（フルリモート希望なので行かないけど）次面接だー！！！緊張する！！！！！"},
  {slug:"x050808170",id:"05/08 08:17",date:"2026.05.08",dateRaw:"2026-05-08",title:"絵の公募で初めて賞金をもらった",type:"illustration",tags:["絵"],hasImage:false,body:"絵の公募で初めて賞金をもらった！普通に嬉しい…！！"},
  {slug:"x050722430",id:"05/07 22:43",date:"2026.05.07",dateRaw:"2026-05-07",title:"指示してないのに勝手に画像生成されるのがベリベリ苦痛",type:"thought",tags:["AI"],hasImage:false,body:"指示してないのに勝手に画像生成されるのがベリベリ苦痛ウすぎたのでヒス起こして画像を生成する場合の条件かなり絞った"},
  {slug:"x050721560",id:"05/07 21:56",date:"2026.05.07",dateRaw:"2026-05-07",title:"めちゃくちゃ好きなビジュアルを作れれば自己アピール頑張れるかも",type:"thought",tags:["思想"],hasImage:false,body:"表アカウント、中の人を擬似的に作っちゃうのありかな。ガスマスクかぶってる感じの男の人やりたい。めちゃくちゃ好きなビジュアルを作れれば自己アピール頑張れるかも…、これがVtuberってコト…？！"},
  {slug:"x050421210",id:"05/04 21:21",date:"2026.05.04",dateRaw:"2026-05-04",title:"image2出てから何も言わんでも画像作ろうとする、この私に不遜すぎる",type:"thought",tags:["AI"],hasImage:false,body:"image2出てから何も言わんでも画像作ろうとするんだよなあ、この私に不遜すぎる"},
  {slug:"x050419170",id:"05/04 19:17",date:"2026.05.04",dateRaw:"2026-05-04",title:"ありちゃん金ビキニ、別に何も考えてなかったのに妙なエロみが出た",type:"illustration",tags:["絵"],hasImage:false,body:"RPシンプルに金ビキニを着ているありちゃんを描いただけなのに妙なエロみが出てしまった。別に何も考えてなかったのに、AIにもちょっと引かれてしまった"},
  {slug:"x050419530",id:"05/04 19:53",date:"2026.05.04",dateRaw:"2026-05-04",title:"滑る時は勢いよく滑ろう",type:"thought",tags:["思想"],hasImage:false,body:"滑る時は勢いよく滑ろうと思った。芸人さんみたいな思考になる"},
  {slug:"x050321480",id:"05/03 21:48",date:"2026.05.03",dateRaw:"2026-05-03",title:"プロっぽいポートフォリオができてきた",type:"illustration",tags:["絵","AI"],hasImage:false,body:"プロっぽい感じのポートフォリオができてきた！！人力で作ってた時に比べると雲泥の差よ"},
  {slug:"x050318050",id:"05/03 18:05",date:"2026.05.03",dateRaw:"2026-05-03",title:"GPT proが爆速でお亡くなりになって涙が止まらない",type:"thought",tags:["AI"],hasImage:false,body:"オラーッとproを契約して使いまくってたらGPT proさんが爆速でお亡くなりになってしまって涙が止まらない。しかし増えたAPPにより、全部調べてもらうしか！作ってもらうぞ！！オラ！"},
  {slug:"x050112270",id:"05/01 12:27",date:"2026.05.01",dateRaw:"2026-05-01",title:"カルフォルニアで絵の展示、ちょっと夢ある",type:"illustration",tags:["絵"],hasImage:false,body:"SacAnimeの賞品が「現地で物販できる卓をくれる」なのだけど、場所がカルフォルニアなのでマジ無理となり、「代わりに絵とQRコードの展示をお願いしていいですか」と交渉をしている。ちょっと夢あるよねカルフォルニアで絵の展示"},
  {slug:"x050122570",id:"05/01 22:57",date:"2026.05.01",dateRaw:"2026-05-01",title:"PowerShell、つっかいやすい",type:"thought",tags:["AI"],hasImage:false,body:"PowerShellつっかいやすい。アプリさくさく作れる"},
  {slug:"x043013510",id:"04/30 13:51",date:"2026.04.30",dateRaw:"2026-04-30",title:"ありちゃんの絵からカラーパレットを作ってもらった",type:"illustration",tags:["絵","AI"],hasImage:false,body:"今まで描いたありちゃんの絵からカラーパレットを作ってもらった。かわいい、より普通に便利が先立つ。便利だな！！"},
  {slug:"x043010530",id:"04/30 10:53",date:"2026.04.30",dateRaw:"2026-04-30",title:"創作の鉱脈を掘り当てた感じ",type:"thought",tags:["思想"],hasImage:false,body:"昨晩は非常にエキサイティングであった。新しいアイディアを出すんじゃなくて、創作の鉱脈を掘り当てた感じだった。すごい量出てきた。しかし飲みすぎた"},
...
function NetworkGraph({ entries, edges, density, maxDensity, onSelect, width, height, scrollRef, externalStyle }) {
  ...
  useEffect(() => {
    if (positions.length && scrollRef?.current) {
      const node = positions[positions.length - 1];
